%% ebcdic2ascii - EBCDIC编码转ASCII编码函数，配合altreadsgy函数使用
%
% 功能说明：
%   将EBCDIC（扩展二进制编码的十进制交换码）格式文本
%   转换为ASCII（美国信息交换标准代码）格式文本
%
% 输入参数：
%   ebcdic - EBCDIC编码的文本数据
%
% 输出参数：
%   ascii  - 转换后的ASCII编码文本
%
% 注意事项：
%   1. EBCDIC主要用于IBM大型机系统
%   2. 确保输入值在1-255范围内
%   3. 常用于读取老式地震数据格式（如SEGY）
%
